...
public class QueryBroadcastSmResult {
  ...
  public QueryBroadcastSmResult(final MessageId messageId, final OptionalParameter[] optionalParameters) {
  ...
  public boolean equals(final Object o) {
    ...
    final QueryBroadcastSmResult that = (QueryBroadcastSmResult) o;
